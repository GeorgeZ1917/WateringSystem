...
/* This library was created by ZeroWolf, and is available at GitHub 
(https://github.com/Preston-Sundar/AVR-AtmegaXX-I2C-library-Old-/blob/master/simple_twi.h). */
...
unsigned char twi_writeChar(unsigned char data){
    ...
    switch (TW_STATUS) {
        case TW_MT_SLA_ACK:     //if any of these statuses are returned, successful write
        case TW_MT_DATA_ACK:
        case TW_MR_SLA_ACK:
        case TW_MR_DATA_ACK:
            return 0;
